...
$email =$_POST['email'];
$academicaRecibida =$_POST['academica'];
$culturalRecibida =$_POST['cultural'];
$entretenimientoRecibida =$_POST['entretenimiento'];
$json   = array();
...
if ($results > 0)
{
    $row = mysqli_fetch_array($query);
        $academica =$academicaRecibida;
        $cultural =$culturalRecibida;
        $entretenimiento =$entretenimientoRecibida;
