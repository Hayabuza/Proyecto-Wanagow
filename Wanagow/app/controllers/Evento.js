 ...
 * de eventos
 */
var acade = Ti.UI.createLabel({left:15,top: 30,width: "auto",
        height:  "auto",zIndex:"5",text: "Académica",color:"white"
}); 
var cul = Ti.UI.createLabel({left:15,top: 70,width:  "auto",
        height:  "auto",zIndex:"6",text: "Cultural | Turística",color:"white"
});
var entre = Ti.UI.createLabel({left:15,top: 110,width: "auto",height:  "auto",
...
function DatosCuenta()
{
  ...
  var fecha = Titanium.UI.createButton({
    ...
    font: {fontFamily: 'Helvetica Neue'},
    color:"white",
    title:datos.fecha//"Fecha de Nacimiento"
  });
