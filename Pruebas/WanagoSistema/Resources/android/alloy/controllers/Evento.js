function Controller() {
    ...
    function diasdelmes(mes, anio) {
        switch (mes) {
          ...
          case "Febrero":
            return 0 == anio % 100 && 0 == anio % 400 || 0 != anio % 100 && 0 == anio % 4 ? 29 : 28;
        }
    }
    function createCal() {
        var columns = 7;
        ...
        enviar.onload = function() {
            ...
            0 == json.length && (tableView.headerTitle = "No hay informacion disponible");
            for (var i = 0; json.length > i; i++) ;
            for (var x = 0; diasdelmes($.fgHeaderTitle.text, fecha.anio) > x; x++) {
    ...
    function DialogoCompartirFacebook(butoon, link, tituloPrincipal, tituloSecundario, descripcion, imagen) {
        ...
        butoon.addEventListener("click", function() {
            ...
            Titanium.Facebook.dialog("feed", data, function(e) {
                ...
                } else e.error ? alert(e.error) : alert("User canceled dialog.");
            });
        });
    }
    ...
    $.tableView.addEventListener("click", function(e) {
        ...
        var share = DialogoCompartirFacebook(buttonRuta, "http://mejorando.la", "Cursos Profesionales", "Django,Node JS", "Los mejores cursos de desarrollo web profesional", "http://www.smartthinking.com.mx/imgs/apps/wanagow.png");
        Ti.API.info(share);
        ...
        buttonOrganizador.addEventListener("click", function() {
            ...
            DialogoCompartirFacebook(FacebookShare, "http://mejorando.la", "Cursos Profesionales", "Django,Node JS", "Los mejores cursos de desarrollo web profesional", "http://www.smartthinking.com.mx/imgs/apps/wanagow.png");
