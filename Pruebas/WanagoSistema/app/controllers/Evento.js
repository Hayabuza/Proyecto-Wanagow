 ...
 //dataArrat sirve para guardar las filas de una tabla
     ...
     */
       $.tableView.addEventListener('click', function(e)
       {
         ...
         var share =DialogoCompartirFacebook(buttonRuta,'http://mejorando.la','Cursos Profesionales','Django,Node JS',
          ...
          buttonOrganizador.addEventListener('click', function(e) {
            ...
            var FacebookShare = Titanium.UI.createButton({opacity : 4.5,
                width:"auto",height:"60px",image:"img/face.png",top:10,
                left:25,borderRadius:10,zIndex:2
            });
            
            DialogoCompartirFacebook(FacebookShare,'http://mejorando.la','Cursos Profesionales','Django,Node JS',
            	'Los mejores cursos de desarrollo web profesional','http://www.smartthinking.com.mx/imgs/apps/wanagow.png');
...
function createCal (args) 
{
  ...
  var idCliente = {
    ...
    for (var x=0;x <diasdelmes($.fgHeaderTitle.text,fecha.anio); x++){
